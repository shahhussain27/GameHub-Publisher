        ...
        children: [
          {
            ...
            route: `/products/analytics/demo`,
          },
          {
            icon: <CiGlobe />,
            label: "World Analytics",
            route: "/products/analytics/world_analtytics/demo",
          },
        ], // dropdown
      },
    ],
...
const Sidebar = () => {
  ...
  return (
    <aside
      className={`absolute left-0 top-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden border-r py-10 border-stroke bg-white dark:border-stroke-dark dark:bg-[#020D1A] lg:static lg:translate-x-0 max-sm:hidden`}
    >

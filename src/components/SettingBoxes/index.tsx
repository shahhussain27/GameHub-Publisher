  ...
  return (
    <>
      <div className="grid grid-cols-5 gap-8">
        <div className="flex flex-col gap-4 col-span-5 xl:col-span-3">
          {/* Company Information */}
          <div className="rounded-[10px] border border-stroke bg-white shadow-1 dark:border-dark-3 dark:bg-gray-dark dark:shadow-card">
            <div className="border-b border-stroke px-7 py-4 dark:border-dark-3">
              <h3 className="font-medium text-dark dark:text-white">Company</h3>
            </div>
            <div className="p-7">
              <form>
                <p className="text-xs mb-7">
                  Manage your company information used for business receipts for
                  your purchase(s).{" "}
                  <a
                    href="https://marosavat.com/vat-number/"
                    target="_blank"
                ...
                <div className="mb-5.5 flex flex-col gap-5.5 sm:flex-row">
                  <div className="w-full sm:w-1/2">
                    ...
                    <div className="relative">
                      <input
                        className="w-full rounded border-[1.5px] border-stroke bg-white py-2.5 px-4.5 text-dark focus:border-primary focus-visible:outline-none dark:border-dark-3 dark:bg-dark-2 dark:text-white dark:focus:border-primary"
                        type="text"
                        name="companyName"
                        id="companyName"
                ...
                <div className="flex justify-end gap-3">
                  <button
                    className="flex justify-center rounded bg-primary px-12 py-2.5 font-bold text-gray-2 hover:bg-opacity-90"
                    type="submit"
                  >
                    Save
                  </button>
                ...
                <div className="mb-5.5 flex flex-col gap-5.5 sm:flex-row">
                  <div className="w-full sm:w-1/2">
                    ...
                    <div className="relative">
                      ...
                      <input
                        className="w-full rounded border-[1.5px] border-stroke bg-white py-2.5 pl-12.5 pr-4.5 text-dark focus:border-primary focus-visible:outline-none dark:border-dark-3 dark:bg-dark-2 dark:text-white dark:focus:border-primary"
                        type="text"
                        name="fullName"
                        id="fullName"
          ...
          <div className="rounded-[10px] border border-stroke bg-white shadow-1 dark:border-dark-3 dark:bg-gray-dark dark:shadow-card">
            ...
            <div className="p-7">
              <form>
                ...
                <div className="flex justify-end gap-3">
                  <button
                    className="flex items-center justify-center rounded bg-primary px-6 py-[7px] font-medium text-gray-2 hover:bg-opacity-90"
                    type="submit"
                  >
                    Save
                  </button>
      ...
      <div className="rounded-[10px] border border-stroke mt-4 bg-white shadow-1 dark:border-dark-3 dark:bg-gray-dark dark:shadow-card">
        ...
        <div className="p-7">
          <form>
            <p className="text-sm">
              Click REQUEST ACCOUNT DELETE to start the process of permanently
              deleting your GameHub Publisher account including all personal
              information, purchases, game progress, in-game content. Once your
              GameHub Publisher account is deleted, your wallet balance will be
              permanently deleted as well.{" "}
            </p>
            <br />
            <h2 className="font-bold text-rose-400 text-sm">
              If you request to delete your account, your account will be
              deleted in 14 days. During this time, you can login to reactivate
              your account, which will cancel your deletion. After 14 days
              deletion will be irreversible.
            </h2>

            <div className="flex justify-end gap-3">
              <button
                className="flex justify-center rounded bg-rose-600 px-10 py-2.5 font-bold text-gray-2 text-sm hover:bg-opacity-90"
                type="submit"
              >
